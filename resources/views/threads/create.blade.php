    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div
                ...
                <form action="{{ route('forum.threads.store') }}" method="POST" x-data="{ isSubmitting: false }"
                    ...
                    <div class="p-6 md:p-8 border-b border-gray-700/50">
                        ...
                        <p class="mt-1 text-gray-400">
                            Bagikan ide, pertanyaan, atau temuan Anda dengan komunitas.
                        </p>
                    </div>
                    ...
                    <div class="p-6 md:p-8">
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div class="md:col-span-2">
                                <label for="title" class="block text-sm font-medium leading-6 text-gray-300 mb-2">Judul</label>
                            ...
                            {{-- Category --}}
                            <div>
                                <label for="category_id" class="block text-sm font-medium leading-6 text-gray-300 mb-2">Kategori</label>
                                <select name="category_id" id="category_id" class="block w-full rounded-md border-0 bg-gray-700/50 py-2.5 px-4 text-white shadow-sm ring-1 ring-inset ring-gray-600 focus:ring-2 focus:ring-inset focus:ring-primary sm:text-sm sm:leading-6 transition-colors duration-200" required>
                        ...
                        <div class="mt-6" x-data="{ content: @js(old('body', '')) }">
                            <label for="body" class="block text-sm font-medium leading-6 text-gray-300 mb-2">Isi Thread</label>
                    ...
                    <div class="mt-4 flex items-center justify-end gap-x-4 bg-gray-800/60 p-6 border-t border-gray-700/50">
                        <a href="{{ url()->previous() }}" class="text-sm font-semibold leading-6 text-gray-300 hover:text-white transition-colors duration-200">Batal</a>
