            ...
            <nav class="flex flex-col gap-6">
                ...
                @auth
                    <a href="{{ route('dashboard') }}"
                        class="text-lg text-white/80 hover:text-white hover:pl-2 transition-all duration-300">Dashboard</a>
                @else
                    <a href="{{ route('login') }}"
    ...
    <div class="bg-black">
        <section class="container mx-auto py-20 px-6">
            <div class="grid md:grid-cols-2 gap-12 items-center">
                <div class="order-2 md:order-1" data-scroll-animation>
                ...
                <div class="order-1 md:order-2" data-scroll-animation>
        ...
        <section class="bg-gray-900 py-20">
            <div class="container mx-auto px-6 text-center">
                <h2 class="text-4xl md:text-5xl font-bebas tracking-wider text-white mb-2" data-scroll-animation>FROM
                    THE
                    PIT</h2>
                <p class="text-lg text-white/60 mb-12 max-w-2xl mx-auto" data-scroll-animation>See what's
                    currently shaking
                ...
                <div class="grid md:grid-cols-3 gap-8">
                    <div class="bg-gray-800 p-8 rounded-lg transform hover:scale-105 transition-transform duration-300"
                        ...
                        <div class="text-red-500 mb-4">
                            <x-icons.discussions class="w-12 h-12 mx-auto" />
                        </div>
                    ...
                    <div class="bg-gray-800 p-8 rounded-lg transform hover:scale-105 transition-transform duration-300"
                        data-scroll-animation style="transition-delay: 150ms;">
                        <div class="text-red-500 mb-4">
                            <x-icons.gigs class="w-12 h-12 mx-auto" />
                        </div>
                    ...
                    <div class="bg-gray-800 p-8 rounded-lg transform hover:scale-105 transition-transform duration-300"
                        data-scroll-animation style="transition-delay: 300ms;">
                        <div class="text-red-500 mb-4">
                            <x-icons.reviews class="w-12 h-12 mx-auto" />
                        </div>
        ...
        <section class="py-20">
            <div class="container mx-auto px-6 text-center" data-scroll-animation>
